...
public class MuLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"TYPE", "STATE", "LIST", "COLON", "COMMA", "PERIOD", "OR", "AND", "EQ", 
			"NEQ", "GT", "LT", "GTEQ", "LTEQ", "PLUS", "MINUS", "MULT", "DIV", "MOD", 
			"POW", "NOT", "P", "SCOL", "ASSIGN", "OPAR", "CPAR", "OBRACE", "CBRACE", 
			"OSQBRA", "CSQBRA", "TRUE", "FALSE", "NIL", "IF", "ELSE", "WHILE", "LOG", 
